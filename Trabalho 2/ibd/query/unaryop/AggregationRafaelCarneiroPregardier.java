...
public class AggregationRafaelCarneiroPregardier extends UnaryOperation {
     ...
     * @throws Exception
     */
    public AggregationRafaelCarneiroPregardier(Operation op, String alias, String groupByTable, String groupByCol, String groupedTable, String groupedCol, int type, boolean isOrdered) throws Exception {
        super(op);
        this.alias = alias;
    ...
    private class AggregationIterator extends UnpagedOperationIterator {
        ...
        protected Tuple findNextTuple() {
            while (tuples.hasNext()) {
                ...
                dataRow.setValue(groupByColumn.getColumnName(), groupByValue);
                dataRow.setValue(aggregateColumn.getColumnName(), aggregateValue);


                System.out.println("column name: " + groupByColumn.getColumnName());
