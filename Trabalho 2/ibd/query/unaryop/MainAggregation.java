...
public class MainAggregation {
    ...
    public Operation testGroupByQuery(Table table, String groupByColumn, String groupedColumn, int type) throws Exception {
        ...
        Operation groupBy = new AggregationRafaelCarneiroPregardier(scan, "g", groupByColumn, groupedColumn, type, false);
        return groupBy;
    ...
    public static void main(String[] args) {
        try {
            ...
            if (recreate)
                table = createPersonTable("C:\\Users\\naoca\\Documents\\GitHub\\Implementacao-de-Banco-de-Dados\\Trabalho 2\\ibd", "tab1", Table.DEFULT_PAGE_SIZE, 100, false, 1, 50);
            else
