...
public class Directory {
    ...
    public static Table getTable(Prototype prototype, String folder, String name, int pageSize, boolean override) throws Exception {
    ...
    public static Table getTable(Prototype prototype, String key, int pageSize, boolean override) throws Exception {
        String folder = getTableFolder(key);
        String file = getTableFile(key);
        return Directory.getTable(prototype, folder, file, pageSize, override);
    }
