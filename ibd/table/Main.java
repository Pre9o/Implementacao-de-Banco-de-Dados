...
public class Main {
    ...
    public void testRangeSearch(Table table, int pk) throws Exception {
        ...
        List<DataRow> list = table.getRecords("id",pk, ComparisonTypes.GREATER_EQUAL_THAN);
    ...
    public static void main(String[] args) {
        try {
            ...
            Table table = Directory.getTable(pt, "C:\\Users\\naoca\\Documents\\GitHub\\Implementacao-de-Banco-de-Dados\\ibd", "newTable", Table.DEFULT_PAGE_SIZE, true);
