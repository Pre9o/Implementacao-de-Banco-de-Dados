...
public class Main {
    ...
    public void testPushDownOptimization(QueryOptimizer opt, Operation query, boolean showTree, boolean runQuery) throws Exception {
    ...
    public static void main(String[] args) {
        try {
            Main m = new Main();
            QueryOptimizer opt = new JoinQueryOptimizer();
