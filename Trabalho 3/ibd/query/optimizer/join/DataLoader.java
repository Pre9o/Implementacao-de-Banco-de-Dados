...
public class DataLoader {
    ...
    public int cacheSize = 0;
     ...
     public void loadData() throws Exception {
        tableMovie = Directory.getTable("C:\\Users\\naoca\\Documents\\GitHub\\Implementacao-de-Banco-de-Dados\\Trabalho 3\\ibd", "movieX", null, cacheSize,Table.DEFULT_PAGE_SIZE, false);
        tableArtist = Directory.getTable("C:\\Users\\naoca\\Documents\\GitHub\\Implementacao-de-Banco-de-Dados\\Trabalho 3\\ibd", "artist", null, cacheSize, Table.DEFULT_PAGE_SIZE, false);
        tableCast = Directory.getTable("C:\\Users\\naoca\\Documents\\GitHub\\Implementacao-de-Banco-de-Dados\\Trabalho 3\\ibd", "cast", null, cacheSize, Table.DEFULT_PAGE_SIZE, false);
        tableDirector = Directory.getTable("C:\\Users\\naoca\\Documents\\GitHub\\Implementacao-de-Banco-de-Dados\\Trabalho 3\\ibd", "director", null, cacheSize, Table.DEFULT_PAGE_SIZE, false);

    }

    public void recreate() throws Exception {
        tableMovie = Directory.getTable(  "C:\\Users\\naoca\\Documents\\GitHub\\Implementacao-de-Banco-de-Dados\\Trabalho 3\\ibd", "movieX",createMovieSchema(),cacheSize, Table.DEFULT_PAGE_SIZE, true);
        tableArtist = Directory.getTable( "C:\\Users\\naoca\\Documents\\GitHub\\Implementacao-de-Banco-de-Dados\\Trabalho 3\\ibd", "artist",createArtistSchema(),cacheSize, Table.DEFULT_PAGE_SIZE, true);
        tableCast = Directory.getTable( "C:\\Users\\naoca\\Documents\\GitHub\\Implementacao-de-Banco-de-Dados\\Trabalho 3\\ibd", "cast",createCastSchema(),cacheSize, Table.DEFULT_PAGE_SIZE, true);
        tableDirector = Directory.getTable( "C:\\Users\\naoca\\Documents\\GitHub\\Implementacao-de-Banco-de-Dados\\Trabalho 3\\ibd", "director",createDirectorSchema(),cacheSize, Table.DEFULT_PAGE_SIZE, true);
    ...
    private Prototype createMovieSchema() {
        ...
        prototype.addColumn(new StringColumn("title", (short)30));
    ...
    private Prototype createArtistSchema() {
        ...
        prototype.addColumn(new StringColumn("name", (short)30));
        return prototype;
    }
