 ...
 * @author Sergio
 */
public class AggregationXXX extends UnaryOperation {
     ...
     * @throws Exception
     */
    public AggregationXXX(Operation op, String alias, String groupByCol, String aggregateCol, int type, boolean isOrdered) throws Exception {
        super(op);
        this.alias = alias;
     ...
     * @throws Exception
     */
    public AggregationXXX(Operation op, String alias, String groupByTable, String groupByCol, String groupedTable, String groupedCol, int type, boolean isOrdered) throws Exception {
        super(op);
        this.alias = alias;
